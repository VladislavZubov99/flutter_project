...
class ModulesTiles extends StatelessWidget {
  const ModulesTiles({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GridView(
        ...
        children: [
          InkWell(
            onTap: () {
              Navigator.of(context).pushNamed(MainNavigationRouteNames.optionsScreen);
            },
            child: Padding(
